...
public class C03_OrtakElementleriBulma {
    ...
    public static void main(String[] args) {
        ...
        Integer[] arr2 = {2, 7, 3, 5, 8, 1, 9, 0, 3, 5, 7};// iki arrayin elementlerini bana getirmesi icin icice iki for-each loop olusturalim
        //elementleri karsilastirip, eger esitlerse ve daha once listeye eklenmemisse listeye ekleyelim
